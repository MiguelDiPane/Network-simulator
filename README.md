...
Per pubblicare questo progetto su GitHub Pages, segui questi passaggi:

1.  Assicurati di avere un repository su GitHub.
2.  Esegui il comando:
    ```bash
    npm run deploy
    ```
3.  Questo comando creerà una build di produzione e la caricherà automaticamente sul branch `gh-pages` del tuo repository.
4.  Nelle impostazioni del repository su GitHub, sotto la sezione **Pages**, seleziona il branch `gh-pages` come sorgente.
